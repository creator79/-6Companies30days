class Solution {
    ...
    //     So the logic is very simple, in square we will have 4 equal sides, and 2 equal diagonals.
    // So if we store all of that in a set, we will get 2 unique values only.
    // So thats what we did, we stored square of each side in a set and at the end if we have 2 unique values and none of the values are 0 then we have a valid square.
